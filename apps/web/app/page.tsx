            ...
            <div className="max-w-3xl">
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-5 sm:pt-6 border-t border-slate-200">
                <div className="flex items-center sm:items-start gap-3 p-3 sm:p-0 rounded-xl bg-white/70 sm:bg-transparent border sm:border-0 border-slate-200/80 shadow-xs sm:shadow-none">
                  ...
                  <div>
                    ...
                    <div className="text-xs sm:text-sm font-bold text-slate-900">Sunday, Oct 25, 2026</div>
                  </div>
                </div>
                ...
                <div className="flex items-center sm:items-start gap-3 p-3 sm:p-0 rounded-xl bg-white/70 sm:bg-transparent border sm:border-0 border-slate-200/80 shadow-xs sm:shadow-none">
                  ...
                  <div>
                    ...
                    <div className="text-xs sm:text-sm font-bold text-slate-900">{event?.venue || 'Courtyard by Marriott, Madurai'}</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#EE8518] hover:bg-[#d26b0f] active:bg-[#ab4e10] text-white font-bold text-sm sm:text-base rounded-xl shadow-md transition-all group text-center"
                >
          ...
          <section className="py-12 sm:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
              {event.ticketTypes.map((category) => (
                <div
                  key={category.id}
                  className="p-5 sm:p-6 rounded-[18px] bg-white border border-slate-200 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow"
                >
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-base sm:text-lg font-bold text-slate-900">{category.name}</h3>
                      <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-[#08537B]/10 text-[#08537B]">
                        {category.remainingCapacity} Left
                      </span>
                    </div>

                    <div className="mt-2.5 mb-3 sm:mb-4">
        ...
        <section className="py-12 sm:py-16 bg-white border-y border-slate-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              <div className="flex items-start gap-3.5 sm:gap-4 p-4 sm:p-0 rounded-2xl bg-slate-50/70 sm:bg-transparent border sm:border-0 border-slate-200/80">
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-[12px] bg-[#08537B]/10 text-[#08537B] flex items-center justify-center shrink-0">
                  <Award className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div>
                  <h3 className="text-sm sm:text-base font-bold text-slate-900">World-Class Speakers</h3>
              ...
              <div className="flex items-start gap-3.5 sm:gap-4 p-4 sm:p-0 rounded-2xl bg-slate-50/70 sm:bg-transparent border sm:border-0 border-slate-200/80">
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-[12px] bg-[#EE8518]/10 text-[#EE8518] flex items-center justify-center shrink-0">
                  <Users className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div>
                  <h3 className="text-sm sm:text-base font-bold text-slate-900">Curated Networking</h3>
                  <p className="mt-1 text-xs text-slate-500 leading-relaxed">
              ...
              <div className="flex items-start gap-3.5 sm:gap-4 p-4 sm:p-0 rounded-2xl bg-slate-50/70 sm:bg-transparent border sm:border-0 border-slate-200/80">
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-[12px] bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0">
                  <Sparkles className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div>
                  <h3 className="text-sm sm:text-base font-bold text-slate-900">Venture Showcase</h3>
                  <p className="mt-1 text-xs text-slate-500 leading-relaxed">
